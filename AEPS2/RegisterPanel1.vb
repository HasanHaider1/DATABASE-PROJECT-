Imports System.IO
Public Class RegisterPanel1
    'Declaring as Public to use throughout the program in diffrent forms and functions
    ...
    Dim imagepath As String = "D:\Inara\Habib University\3rd Sem\Database\Project\Images"

    'The President, Vice President, and the Treasurer shall not be from the first year class. 
    'The Secretary can be from the first three classes. (i.e. Not from the Senior most batch).
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If dataTable.Rows.Count > 0 Then
            If stdInfoP1.Contains(TextBox1.Text.ToString) Then
        ...
        stdInfoP1.Add(TextBox1.Text.ToString)
    ...
    Private Sub RegisterPanel1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim counter As Integer
        dt = db.SelectQuery(" Select count(*) from CandidatesWonAlready")
        counter = (dt.Rows.Item(0).Item(0)) - 1
        dt = db.SelectQuery("Select * from CandidatesWonAlready")
        For c As Integer = 0 To counter
            stdInfoP1.Add(dt.Rows.Item(c).Item(0).ToString())
        Next
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        'If the student Id exists then do the following:
        If dataTable.Rows.Count > 0 Then
            If stdInfoP1.Contains(TextBox3.Text.ToString) Then
                MessageBox.Show("Student already a member of the panel")
                TextBox3.Clear()
            Else
                'Add the full name in the name combo box
        ...
        Else
            ...
            'Add student already chosen in list
            stdInfoP1.Add(TextBox3.Text.ToString)
        End If
    End Sub
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        'If the student Id exists then do the following:
        If dataTable.Rows.Count > 0 Then
            If stdInfoP1.Contains(TextBox2.Text.ToString) Then
                MessageBox.Show("Student already a member of the panel")
                TextBox2.Clear()
            Else
                'Add the full name in the name combo box
        ...
        Else
            ...
            'Add student already chosen in list
            stdInfoP1.Add(TextBox2.Text.ToString)
        End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        srcFile = PanelInfo1.PictureBox1.ImageLocation
        MessageBox.Show("path: " + srcFile)
        dstFile = dstFile + PanelInfo1.MaskedTextBox1.Text.ToString + PanelInfo1.MaskedTextBox2.Text.ToString + ".jpg"
        File.Copy(srcFile, dstFile)
        dataTable = db.SelectQuery("Select top 1 PanelID from PanelInfo order by PanelID desc")
        panelID = dataTable.Rows.Item(0).Item(0) + 1
        ...
        db.InsertQuery("EXEC AddPanelInfo " + panelID.ToString() + ",'" + PanelInfo1.MaskedTextBox1.Text.ToString + "' , '" + PanelInfo1.RichTextBox1.Text.ToString + "' , '" + PanelInfo1.MaskedTextBox2.Text.ToString + "' , '" + dstFile + "'")
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        'If the student Id exists then do the following:
        If dataTable.Rows.Count > 0 Then
            If stdInfoP1.Contains(TextBox4.Text.ToString) Then
                MessageBox.Show("Student already a member of the panel")
                TextBox4.Clear()
            Else
                'Add the full name in the name combo box
        ...
        Else
            ...
            'Add student already chosen in list
            stdInfoP1.Add(TextBox4.Text.ToString)
        End If
